...
function setNuPropMainImg(tPrpIarrIndx) {
 ...
 tPrpImgObj = tmpPropImgArr[tPrpIarrIndx];
    ...
    if(tPIOcatid == 5) {
        tPrpimg = tPrpImgObj.m_file;
        if(tPrpimg.indexOf("updt_") != -1) {
            tPrpimg = tPrpimg.replace("updt_", "");
            tLderIMG.src = "images/ucontent/m_thumb" + tPrpimg;
        } else {
            tLderIMG.src = "images/property/m_thumb" + tPrpimg;
        }
    } else {
    ...
    if(theAIb.indexOf("_id") != -1) {
     ...
     tstr += "<div class=\"swiper swiperPrp\" style=\"width: 400px;height:140px;\"> <div class=\"swiper-wrapper\">";
        ...
        while (iirnt < awlen) {
            ...
            if(tIRcatid == "5")  {
                tPrpimg = tAiretArr[iirnt]["m_file"];
                if(tPrpimg.indexOf("updt_") != -1) {
                    tPrpimg = tPrpimg.replace("updt_", "");
                tImageFstr = "images/ucontent/m_thumb" + tPrpimg;

            tstr += "<div class=\"swiper-slide\"> <a href=\"javascript:setNuPropMainImg('" + iirnt + "');\"><img class=\"rtable\" style=\"width: 100%;min-height:125px;\"  src=\"images/ucontent/s_thumb" + tPrpimg + "\"  alt=\"image\"></a> </div>";
                } else {
            ...
            tstr += "<div class=\"swiper-slide\"> <a href=\"javascript:initNwstThreeDView('"  + tAVImgUstr + "','"+ /* qmedia _id */ tAiretArr[iirnt]["_id"] + "');\">" + t3DImgStr + "</a>";
            tstr += "<div class=\"txtBold txtSmall txtClrBlue\" style=\"text-align: center;\"><a href=\"javascript:initNwstThreeDView('"  + tAVImgUstr + "','"+ /* qmedia _id */ tAiretArr[iirnt]["_id"] + "');\">3D View</a></div>";
            tstr += "</div>";
             } else {
...
tPrpImgsFlr = currPrpImgsFldr + "/";
// if aprpImage contains updt_ then remove updt_ from the string and currPrpImgsFldr = "images/ucontent/"
if(aprpPimage.indexOf("updt_") != -1) {
    aprpPimage = aprpPimage.replace("updt_", "");
    tPrpImgsFlr = "images/ucontent/";
}
if(aprpPimage.indexOf("updt3d_") != -1) {
    ttprpPimage = aprpPimage.replace("updt3d_", "");
   // url decode and LZ decompress
    aprpPimage = LZString.decompressFromEncodedURIComponent(decodeURIComponent(ttprpPimage));
    tPrpImgsFlr = "";
    setTimeout(function(){ initNwstThreeDView(aprpPimage, 101); }, 2000);
}
...
//   <div id="street-view" style="min-height:400px;min-width:99%;max-width:99%;position:absolute;visibility:visible;display:block;"></div>
    ...
    retPLstSTr += "<img src=\"" + tPrpImgsFlr  + aprpPimage + "\" alt=\"pimage\" class=\"img100p\" id=\"imgAPrpMain\">";
