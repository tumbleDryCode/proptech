...
tmpRetStr += "</div>";
  ...
  //  t3DpopStr += "<div class=\"dvTxtBtns\"><input type=\"button\" class=\"btnTxtLabel\" value=\"Get Image URL\" onclick=\"javascript:updtCurr3DImgUrl('" + + "');\"></div>";
   ...
   if(currGglSVloaded == "no") {
       currGglSVloaded = "y";
       console.log("doNuThreeDPop:script load " + gglSKey);
...
var doThreeDPop = function() {
   ...
   //  t3DpopStr += "<div class=\"dvTxtBtns\"><input type=\"button\" class=\"btnTxtLabel\" value=\"Get Image URL\" onclick=\"javascript:saveCurr3DImgUrl();\"></div>";
    ...
    function strtStpNuTDAnm(tNTDAurl) {
        console.log("startStopNuTDAnim: " + tNTDAurl);
 ...
 var { PinElement } = await google.maps.importLibrary("marker");
     ...
     threedmap.addEventListener('gmp-click', (event) => {
      ...
      advThreeDPop.append(threedmap);
        ...
        t3DpopStr += "<input id=\"btnAEPadd\" type=\"button\" class=\"btnTxtLabel\" value=\"Save\" onclick=\"javascript:saveCurr3DImgUrl();\">";
        t3DpopStr += "<input id=\"btnAEPplay\" type=\"button\" class=\"btnTxtLabel\" value=\"Play\" onclick=\"javascript:strtStpNuTDAnm(" + fltdLat + "," + fltdLng + ",10);\">";
 
        t3DpopStr += "<input id=\"btnAEPstop\"  type=\"button\" class=\"btnTxtLabel\" value=\"Stop\" onclick=\"javascript:threedmap.stopCameraAnimation();\">";
        // delete button
        t3DpopStr += "<input id=\"btnAEPdel\" type=\"button\" class=\"btnTxtLabel\" value=\"Delete\" onclick=\"javascript:JSSHOP.ui.closeLbox();\">";
        t3DpopStr += "</div>";
     ...
     if(threedmap != null && threedmap != undefined && threedmap != "") {
         ...
         threedmap.addEventListener('gmp-click', (event) => {
          ...
          // add listener to log the range, tilt and heading of the map
            ...
            var t3DpopStr = "";
            t3DpopStr += "<div class=\"dvTxtBtns\">";
            t3DpopStr += "<input id=\"btnAEPadd\" type=\"button\" class=\"slmtable txtSmall\" value=\"Save\" onclick=\"javascript:updtCurr3DImgUrl('" + tMdiaID + "');\">";
 // doNuPrdMDelete(tMdiaID,'get3DImages');
     t3DpopStr += "<input id=\"btnTDPopdel\" type=\"button\" class=\"slmtable txtSmall\" value=\"Delete\" onclick=\"javascript:doNuPrdMDelete(" + tMdiaID + ",'get3DImages');\">";
            t3DpopStr += "<input id=\"btnAEPplay\" type=\"button\" class=\"slmtable txtSmall\" value=\"Play\" onclick=\"javascript:strtStpNuTDAnm(getCurr3DImgUrl(280,140));\">";
            t3DpopStr += "<input id=\"btnAEPstop\"  type=\"button\" class=\"btnTxtLabel\" value=\"Stop\" onclick=\"javascript:threedmap.stopCameraAnimation();\">";
            t3DpopStr += "</div>";
            tHlderDiv = document.createElement("div");
            tHlderDiv.innerHTML = t3DpopStr;
