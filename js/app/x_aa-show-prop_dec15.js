...
function initStreetView(tlat, tlng) {
...
function doSVLoad(tlat, tlng) {
    ...
    if(currGglSVloaded == "no") {
        currGglSVloaded = "y";
        JSSHOP.loadScript("https://maps.googleapis.com/maps/api/js?key=AIzaSyAiBR8BEPj2YCepKplisQKK709r1TI48Vo", initStreetView,"js");
        } else {
            initStreetView(tlat, tlng);
        }
}
...
//   <div id="street-view" style="min-height:400px;min-width:99%;max-width:99%;position:absolute;visibility:visible;display:block;"></div>
    retPLstSTr += "<div id=\"street-view\" style=\"min-height:400px;min-width:99%;max-width:99%;position:absolute;visibility:visible;display:block;\"></div>";
      
    retPLstSTr += "<div class=\"overlay-black overflow-hidden position-relative crsrPointer hover-zoomer\" onclick=\"javascript:eindex('aa-show-prop','pid=aa-show-prop&prpid=" + aprpObj._id + "')\"> <img src=\"" + currPrpImgsFldr + "/" + aprpPimage + "\" alt=\"pimage\" class=\"img100p\" id=\"imgAPrpMain\">";
