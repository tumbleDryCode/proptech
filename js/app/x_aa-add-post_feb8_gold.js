...
function setPostAdd() {
    ...
    if(tSlctdPstType == "pimage") {
       ...
       daNewDiv = document.createElement("div");
       daNewDiv.appendChild(daDiv.cloneNode(true));
       tZpd = LZString.compressToEncodedURIComponent(daNewDiv.innerHTML);
       tSlctdPrpsArr = JSSHOP.shared.getSlctdPrpsArr();
       tSlctdPrpsStr = JSON.stringify(tSlctdPrpsArr);
       tZpd = LZString.compressToEncodedURIComponent(tSlctdPrpsStr) + "dlmtd" + tZpd;
       ...
       //  tZpd = LZString.compressToEncodedURIComponent(daDiv.innerHTML);
         ...
         console.log("setPostAdd: pimage vars: " + tZpd);   
    }
