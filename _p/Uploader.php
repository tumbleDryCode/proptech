...
class FileUpload {
    ...
    public $allowedExtensions = array('gif', 'png', 'jpg', 'jpeg');            // Array of permitted file extensions
    ...
    public function setFileName($theName) {
        $this->newFileName = $theName;
    }
    ...
    public function handleUpload($uploadDir = null, $allowedExtensions = null) {
		...
		// 
            $this->setErrorMsg($this->fileName);
        return true;
	  }
