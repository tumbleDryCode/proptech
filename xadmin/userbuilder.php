						...
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active"><ti data-ison="stxt[1026]" data-desc="btn_adminlist">Builder List</ti></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title"><ti data-ison="stxt[1026]" data-desc="btn_adminlist">Builder List</ti></h4>
									<?php 
										if(isset($_GET['msg']))	
										echo $_GET['msg'];	
									?>
